...
class PropiedadModel extends Model {
  ...
  protected $allowedFields = [ 'propiedadPropietarioId', 'propiedadCalle', 'propiedadExt',
                                'propiedadInt', 'propiedadColoniaId', 'propiedadMapa',
                                'propiedadDistanciaCentro', 'propiedadRegadera', 'propiedadMedioBano',
                                'propiedadResidencial', 'propiedadGolf', 'propiedadEstacionamiento',
                                'propiedadSuperficie'
                              ];
