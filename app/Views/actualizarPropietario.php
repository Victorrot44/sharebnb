      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card-box">
            ...
            $telefono = $info['telefonos'];
            ?>
            <?= form_open('propietarios/actualizar-propietario/'. $propietario->id, ['id' => 'propietario']) ?>
              <div class="form-row">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <label for="name" class="col-form-label">Nombre</label>
                  <input type="text" id="name" name="nombre" class="form-control text-uppercase" placeholder="Nombre" value="<?= $propietario->nombre ?>">
                </div>
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <label for="paterno" class="col-form-label">Apellido Paterno</label>
                  <input type="text" id="paterno" name="paterno" class="form-control text-uppercase" placeholder="Apellido Paterno" value="<?= $propietario->paterno ?>">
                </div>
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <label for="materno" class="col-form-label">Apellido Materno</label>
                  <input type="text" id="materno" name="materno" class="form-control text-uppercase" placeholder="Apellido Materno" value="<?= $propietario->materno ?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <label for="telefono" class="col-form-label">Teléfono</label>
                  <input type="text" id="telefono" name="telefono[]" class="form-control phone-1" placeholder="Teléfono" value="<?= $telefono[0]->telefono ?>">
                </div>
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <label for="type" class="col-form-label">Tipo de Teléfono</label>
                  <select name="tipo[]" id="type" class="custom-select target"></select>
                </div>
              ...
              <div class="form-row">
                <?php for ($i=1; $i < count($telefono) ; $i++): ?>
                  <div class="col-12 row" id="panel-<?= $i + 1 ?>">
                    <div class="form-group col-sm-12 col-md-4 col-xl-4">
                      <label for="phone-<?= $i + 1 ?>" class="col-form-label">Teléfono <?= $i + 1 ?></label>
                      <input type="text" id="phone-<?= $i + 1 ?>" name="telefono[]" class="form-control" placeholder="Teléfono" value="<?= $telefono[$i]->telefono ?>">
                    </div>
                    <div class="form-group col-sm-12 col-md-4 col-xl-4">
                      <label for="type-<?= $i + 1 ?>" class="col-form-label">Tipo de Teléfono</label>
                      <select name="tipo[]" id="type-<?= $i + 1 ?>" class="custom-select target"></select>
                    </div>
                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                      <button type="button" class="btn btn-danger" title="Descartar" onclick="remover(<?=$i + 1?>);">
              ...
              <div class="form-row">
                <div class="form-group col-sm-12 col-md-3">
                  ...
                  <input type="text" id="calle" name="calle" class="form-control text-uppercase" placeholder="Calle" value="<?= $propietario->calle ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="externo" class="col-form-label">No. Ext</label>
                  <input type="text" id="externo" name="externo" class="form-control" placeholder="No. Externo" value="<?= $propietario->exterior ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="interno" class="col-form-label">No. Int</label>
                  <input type="text" id="interno" name="interno" class="form-control" placeholder="No. Interior" value="<?= $propietario->interior ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="cp" class="col-form-label">C.P.</label>
                  <input type="text" id="cp" name="cp" class="form-control" placeholder="Codigo Postal" value="<?= $propietario->cp ?>">
                </div>
              </div>
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="form-group col-sm-12 col-md-3">
                  ...
                  <input type="text" id="clabe" name="clabe" class="form-control text-uppercase" placeholder="CLABE" value="<?= $propietario->clabe ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="cuenta" class="col form-label">Cuenta</label>
                  <input type="text" id="cuenta" name="cuenta" class="form-control" placeholder="Cuenta" value="<?= $propietario->cuenta ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="ine" class="col form-label">INE</label>
                  <input type="text" id="ine" name="ine" class="form-control text-uppercase" placeholder="INE" value="<?= $propietario->ine ?>">
                </div>
                <div class="form-group col-sm-12 col-md-3">
                  <label for="rfc" class="col form-label">RFC</label>
                  <input type="text" id="rfc" name="rfc" class="form-control text-uppercase" placeholder="RFC" value="<?= $propietario->rfc ?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-sm-12 col-md-4">
                  <label for="email" class="col form-label">Correl Electronico</label>
                  <input type="text" id="email" name="correo" class="form-control" placeholder="Correl Electronico" value="<?= $propietario->correo ?>">
...
<?= $this->section('js') ?>
  ...
  <script>
    ...
    var cantidad = <?= count($telefono) ?>;
    function addInputs() {
      cantidad = cantidad + 1;
      // var html = $('#add-phone').html();
      var html = `<div class="col-12 row" id="panel-${cantidad}">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center">
                  <button type="button" class="btn btn-danger" title="Descartar" onclick="remover(${cantidad});">
                    <i class="fa fa-times"></i>
                  </button>
                </div> </div>`;
